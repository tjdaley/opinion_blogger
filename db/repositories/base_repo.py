...
class BaseRepository(Generic[T]):
    ...
    def select_one(self, condition: dict[str, Any]) -> BaseModel:
        return self.manager.select_one(self.table_name, self.model_class, condition)
    
    def select_many(self, condition: dict[str, Any], sort_by: Optional[str] = None, sort_direction: str = "asc", start: Optional[int] = None, end: Optional[int] = None) -> tuple[List[BaseModel], int]:
    ...
    def update(self, record_id: Any, data: dict[str, Any]) -> BaseModel:
